...
public:
	...
	static Matrix4Row CreateScale(const Vec3& scaleVector)
	{
	...
	static Matrix4Row CreateTranslation(const Vec3& trans)
	{
		float temp[4][4] =
		{
			{ 1.0f, 0.0f, 0.0f, 0.0f },
	...
	static Matrix4Row CreateLookAt(const Vec3& eye, const Vec3& target, const Vec3& up)
	{
