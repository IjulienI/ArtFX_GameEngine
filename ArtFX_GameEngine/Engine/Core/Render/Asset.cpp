...
Texture Asset::LoadTexture(Renderer& renderer, const std::string& filePath, const std::string& name)
{
...
Texture Asset::LoadTextureFromFile(Renderer& renderer, const std::string& filePath)
{
    Texture texture;
